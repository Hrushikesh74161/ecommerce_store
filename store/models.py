...
class ProductSpecification(models.Model):
    ...
    """
    The product specificaiton table contains product
...
class ProductSpecificationValue(models.Model):
    """
    Product Specification value table holds each of the
...
class ProductImage(models.Model):
    ...
    # used as main image for product if set to true
